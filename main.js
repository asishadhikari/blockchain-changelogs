...
var drivedata = require('./drivedata.js');
...
//control http server for user to see blockchain, mine, peers, and add peer on the node
var initHttpServer = () => {
    var app = express();
...
//websocket initialises a server and fires initconnection
var initP2PServer = () => {
...
//init connection with a new peer as given in ws
